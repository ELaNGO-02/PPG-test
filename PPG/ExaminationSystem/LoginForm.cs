    ...
    public partial class LoginForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (usr == "Student")
            {
                try
                {
                    SqlConnection con = new SqlConnection("Data Source=ELANGO\\SQLEXPRESS;Initial Catalog=signup;User ID=your_id;Password=your_pass");
                    con.Open();
                    ...
                    string newcon = "select ID from signuptable where ID='" + textBox1.Text + "' and Password='" + textBox2.Text + "'";
